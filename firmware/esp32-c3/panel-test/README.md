...
Drives the HU-058D display from an ESP32-C3 with nothing but the Arduino
core. 
...
| --- | --- | --- | --- |
| GPIO10 | 14 on HU-058D; 16 on HU-058 / HU-058SE | CLK | Driver 1 clock |
| GPIO7 | 5 | DATA | Driver 1 data |
| GPIO4 | 1 | CLK_1 | Driver 2 clock |
| GPIO5 | 2 | DATA_1 | Driver 2 data |
