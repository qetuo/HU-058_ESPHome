...
// Drives both display buses from an ESP32-C3, with no dependency on
...
static const int PIN_CLK = 10;     // socket pin 14 (HU-058D) or 16 (HU-058/SE), driver 1 clock
static const int PIN_DATA = 7;    // socket pin 5,  driver 1 data
static const int PIN_CLK_1 = 4;   // socket pin 1,  driver 2 clock
static const int PIN_DATA_1 = 5;  // socket pin 2,  driver 2 data
